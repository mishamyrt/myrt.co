    ...
    return (
        <div className="projects">
            <div className="projects-item">
                ...
                <p>Руковожу командой из 5 человек. Выстроил процессы так, чтобы люди не выгорали. Оптимизировал обмен информацией между бизнесом и разработкой. Ввел обязательное код ревью, сделал для этого систему.</p>
                <p>Помог девопсам построить CI/CD конвеер. Написал 2 микросервиса на Node.JS и один на Go.</p>
                <p>Активно делюсь знаниями и предлагаю свои решения. Не боюсь спорить с архитектором и аналитиками.</p>
            </div>
            <div className="projects-item">
                <div className="projects-dateContainer">
