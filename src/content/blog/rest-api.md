...
description: "Моё видение хорошего HTTP API"
tags: []
---
...
Для передачи параметров используйте путь и тело запроса. Обычно PUT используют для полной замены ресурса по URI.
Если отдельное поле ресурса имеет свою бизнес-логику, его можно вынести в отдельный подпуть и обновлять через PUT.
...
|---|---|
| 200 | Ресурс удалён |
| 200 | Ресурс удалён без тела ответа |
| 400 | Переданы некорректные значения |
