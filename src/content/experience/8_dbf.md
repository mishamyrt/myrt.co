...
Разработал AI RAG чат–бот для казахстанских госслужащих на Go. Написал процедуры (предобработка, ретривер, промпты для генератора) для краткого изложения, поиска противоречий и недостующей информации, сверку с нормативной базой.
